...
\begin{figure}[h]
\caption{Vue d'ensemble de la Cité des métiers de Bruxelles. En haut, les salles d'animations collectives ; au milieu, le comptoir d’accueil ; en bas, les ordinateurs et tablettes pour la recherche d'emploi (Source: Cité des métiers de Bruxelles)}
\end{figure}
\end{center}

\begin{SCfigure}[0.5][h]
\caption{La bibliothèque (Source: Cité des métiers de Bruxelles)}
\includegraphics[scale=1.5]{2-cdm-bibliotheque.JPG}
\end{SCfigure}
\begin{SCfigure}[0.5][h]
\caption{Le centre de documentation (Source: Cité des métiers de Bruxelles)}
\includegraphics[scale=1.5]{3-cdm-centre_de_documentation.JPG}
\end{SCfigure}
\begin{SCfigure}[0.5][h]
\caption{L'espace conseil (Source: Cité des métiers de Bruxelles)}
\includegraphics[scale=1.4]{4-cdm-espace_conseil.JPG}
\end{SCfigure}
\begin{SCfigure}[0.5][h]
\caption{L'auditorium (Source: Cité des métiers de Bruxelles)}
\includegraphics[scale=1.4]{5-cdm-auditorium.JPG}
\end{SCfigure}
\begin{SCfigure}[0.5][h]
\caption{L'espace travail isolé sur la mezzanine (Source: Cité des métiers de Bruxelles)}
\includegraphics[scale=1.4]{6-cdm-espace_de_travail.JPG}
\end{SCfigure}
...
\end{SCfigure}
\begin{figure}[h]
\caption{Echantillons de l'étude}
\end{figure}
\end{center}
